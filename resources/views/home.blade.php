...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Liste des matchs</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Liste des matchs</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <form class="d-flex align-items-center search-form" action="{{ route('home') }}" method="get">
                                <input autocomplete="short_description" autofocus value="{{ $search }}"
                                    class="input-search mr-4" name="search" placeholder="EquipeA vs EquipeB" type="text">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">{{__('add a new match')}}
                                            </h1>
                                        ...
                                        <form method="POST" action="{{ route('product.store') }}"
                                            ...
                                            <div class="mb-3">
                                                <label for="titleNewMatch" class="form-label">Pétite description</label>
                                                <input type="text"
                                                    class="form-control @error('short_description') is-invalid @enderror"
                                                    name="short_description" value="{{ old('short_description') }}" required
                                                    autocomplete="short_description" autofocus id="titleNewMatch">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mt-3 d-flex align-items-center">
                                                    <input checked class="w-fit-content" name="possibility_match_complet"
                                                        type="checkbox">
                                                    <label class="form-label mx-2 mb-0">Match complet</label>
                                                </div>
                                                <div class="mt-3 d-flex align-items-center">
                                                    <input checked class="w-fit-content" name="possibility_hight_light"
                                                        type="checkbox">
                                            ...
                                            <div class="mb-3">
                                                <label for="description" class="form-label">Description du match</label>
                                            ...
                                            {{-- <div class="mb-3">
                                                <label for="listJoueurNewMatch" class="form-label">Liste des
                                                    joueurs</label>
                                                <input type="text" class="form-control" id="listJoueurNewMatch"
                                                ...
                                                <td class="d-flex align-items-center">
                                                    ...
                                                    <div class="modal fade" id="modify{{ $key }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5"
                                                                        id="modify{{ $key }}Label">Modifier le match
                                                                    </h1>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <form method="POST"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $item['short_description'] }}" required
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('saison') is-invalid @enderror"
                                                                            name="saison" value="{{ $item['saison'] }}"
                                                                            required autocomplete="saison" autofocus
                                                                            id="saison">
                                                                        @error('saison')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('residence') is-invalid @enderror"
                                                                            name="residence" value="{{ $item['residence'] }}"
                                                                            required autocomplete="residence" autofocus
                                                                            id="residence">
                                                                        @error('residence')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('visitor') is-invalid @enderror"
                                                                            name="visitor" value="{{ $item['visitor'] }}"
                                                                            required autocomplete="visitor" autofocus
                                                                            id="visitor">
                                                                        @error('visitor')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="n_disque" class="form-label">Numéro de la
                                                                            disque</label>
                                                                        <input type="number"
                                                                            class="form-control @error('n_disque') is-invalid @enderror"
                                                                            name="n_disque" value="{{ $item['n_disque'] }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="date_match" class="form-label">Date du
                                                                            match</label>
                                                                        <input type="date"
                                                                            class="form-control @error('date_match') is-invalid @enderror"
                                                                            name="date_match"
                                                                    ...
                                                                    {{-- <div class="mb-3">
                                                                        <label for="matchs" class="form-label">Video du
                                                                            match</label>
                                                                        <input type="file"
                                                                            class="form-control @error('matchs') is-invalid @enderror"
                                                                            name="matchs" value="{{ old('matchs') }}"
                                                                            required autocomplete="matchs"
                                                                            accept="video/mp4,video/x-m4v,video/*" autofocus
                                                                            id="matchs">
                                                                        @error('matchs')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('journey') is-invalid @enderror"
                                                                            name="journey" value="{{ $item['journey'] }}"
                                                                            required autocomplete="journey" autofocus
                                                                            id="journey">
                                                                        @error('journey')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="result" class="form-label">Résultat du
                                                                            match</label>
                                                                        <input type="text"
                                                                            class="form-control @error('result') is-invalid @enderror"
                                                                            name="result" value="{{ $item['result'] }}"
                                                                            required autocomplete="result" autofocus
                                                                            id="result">
                                                                        @error('result')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="description"
                                                                            class="form-label">Description du match</label>
                                                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                                    ...
                                                    <input type="text" class="form-control" id="listJoueurNewMatch"
                                                        placeholder="Séparer par virgule">
                                                                    ...
                                                                    <div class="mb-3 d-flex align-items-center">
                                                                        <input class="w-fit-content" name="is_right_now"
                                                                            id="is_right_now"
