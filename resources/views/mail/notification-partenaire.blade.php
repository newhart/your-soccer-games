                                ...
                                <tr>
                                    <td style="color:#153643;">
                                        <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">
                                            Bonjour {{ $email_infos['name'] }},</h1>
                                        <p
                                            style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif; color:#70bbd9;">
                                            Vous est ajouter en t'en que partenaires dans Your Soccer Games, veuillez
                                            confirmer est creer votre mots de passe .
                                        </p>
                                        <p
                                        ...
                                        <div
                                            ...
                                            <a href="{{ $email_infos['url'] }}" type="submit" class="btn-btn-primary"
                                                target="_blank">
                                                Confimer
                                            </a>
                                        </div>
