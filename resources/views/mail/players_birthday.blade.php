                                ...
                                <tr>
                                    <td style="color:#153643;">
                                        <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">
                                            Liste des joueurs qui ont leur anniversaire aujourd'hui,</h1>

                                        <p>Pour télécharger la liste des joueurs qui ont leur anniversaire aujourd'hui,
                                            veuillez cliquer sur le lien ci-dessous :</p>
                                        <a href="{{ asset('storage/players_birthday_' . \Carbon\Carbon::today()->format('Y_m_d') . '.csv') }}"
                                            download="Players_Birthday_{{ \Carbon\Carbon::today()->format('Y_m_d') }}.csv">
